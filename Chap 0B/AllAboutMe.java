...
class Main
{
	...
	{
		System.out.println("APCS 2020  Ivy Yip                 8/25/2020 ");
		...
		int  numTextMessages;	
    float myShoeSize;
    double myLeftEyePrescription;
    char myGender;
    boolean loveMexicanFood;
    ...
    String favoriteSong;	
		...
		myAge = 14;
		numTextMessages = 5987;	
    myShoeSize = 4.5f;
    myLeftEyePrescription = 4.25;
    myGender = 70;
    loveMexicanFood = false;
    favoriteColor = "Black";
    favoriteSong = "Dynamite";
        ...
        // *******************************************************
		System.out.println();
		System.out.println("      Ms. Ivy Yip");
    System.out.println("      2409 Berkleys Brook Drive");
    System.out.println("      Austin, TX  78738");
    System.out.println();
    ...
    System.out.println();
    System.out.println(" My left eye prescription is -----> " + myLeftEyePrescription);
    System.out.println();
    System.out.println(" My gender is -----> " + myGender);
    System.out.println();
    System.out.println(" I love Mexican food -----> " + loveMexicanFood);
    System.out.println();
